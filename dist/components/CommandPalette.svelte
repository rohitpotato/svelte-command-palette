<script lang="ts">
	...
	import type { ActionId, commands, storeParams, className, action } from '../types';
...
<style>
	...
	:global(.light) .cp-input::-moz-placeholder, :global(html.light) .cp-input::-moz-placeholder, :global(body.light) .cp-input::-moz-placeholder {
		color: #9ca3af;
	}
